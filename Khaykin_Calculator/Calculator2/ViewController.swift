...
class ViewController: UIViewController {
    ...
    private var resultLabel: UILabel = {
        ...
        label.font = UIFont(name: "Gilroy", size: 100)
        return label
    }()
    ...
    private func setupNumberPad() {
        ...
        zeroButton.titleLabel?.font = UIFont(name: "Gilroy", size: FontSize)
        zeroButton.tag = 1
        ...
        clearButton.backgroundColor = .init(red: 2, green: 0.5, blue: 0.5, alpha: 1)
        clearButton.titleLabel?.font = UIFont(name: "Gilroy", size: FontSize-4)
        ...
        for x in 0..<5 {
            ...
            button_operand.backgroundColor = .init(red: 0.5, green: 2, blue: 0, alpha: 1)
            button_operand.setTitle(operations[x], for: .normal)
            button_operand.tag = x+1
            button_operand.titleLabel?.font = UIFont(name: "Gilroy", size: FontSize)
